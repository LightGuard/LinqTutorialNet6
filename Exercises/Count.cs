...
namespace Exercises
{
    public static class Count
    {
        ...
        {
            return words.Count(w => w.Length > 10);
        }
        ...
        {
            var numberOfEvenNumbers = numbers.Count(n => n % 2 == 0);
            var numberOfOddNumbers = numbers.Count() - numberOfEvenNumbers;
            return numberOfOddNumbers < numberOfEvenNumbers;
        }
